      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:hidden grid grid-cols-2 gap-4 mt-8">
            <img src={Pessoa1} className="rounded-2xl shadow-lg" alt="Colaborador 1" width={300} height={400} loading="lazy" />
            <img src={Pessoa2} className="rounded-2xl shadow-lg" alt="Colaborador 2" width={300} height={400} loading="lazy" />
          </div>
        </div>
      </div>
    </section>
