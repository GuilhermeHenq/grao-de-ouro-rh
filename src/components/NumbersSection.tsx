...
const StatCard = ({ s, inView }) => {
  ...
  return (
    <div 
      className="relative group overflow-hidden rounded-[2.5rem] p-[2px] flex flex-col" // Padding de 2px define a espessura da borda
      onMouseMove={handleMouseMove}
    >
      {/* --- ANIMAÇÃO DA BORDA (BEAM) --- */}
      {/* O gradiente agora gira atrás de um fundo 100% opaco */}
      ...
      {/* Spotlight do Mouse - Ajustado para fundo sólido */}
      <motion.div
      ...
      {/* Conteúdo do Card com COR FIXA (100% Opacidade) */}
  ...
  return (
    <section id="numeros" className="py-20 lg:py-28 bg-[#F9FAFB] relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 relative z-10" ref={ref}>
        {/* Container Principal ajustado para fundo sólido claro */}
